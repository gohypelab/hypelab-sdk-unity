...
public class AndroidManifestPostProcessor : IPostGenerateGradleAndroidProject {
  public void OnPostGenerateGradleAndroidProject(string basePath) {
    ...
    //(Comment the hardwareAccelerated lines if you really don't care. We use it for our Webview feature for rendering
    // videos in webview)
    ...
    androidManifest.SetApplicationAttribute("debuggable",
...
internal class AndroidXmlDocument : XmlDocument {
  ...
  public string Save() { return SaveAs(m_Path); }
